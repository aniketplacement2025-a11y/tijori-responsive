...
class _CommercialRegisterPageState extends State<CommercialRegisterPage> {
  ...
  String selectedType = 'Job Title'; // This should match one of the items in typeList
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          DropdownButtonFormField(
                            value: selectedType, // This should be 'Business Manager' not 'Individual'
